...
public class RazorViewRenderer : IRazorViewRenderer
{
    ...
    {
        var actionContext =
            new ActionContext(_contextAccessor.HttpContext, new RouteData(), new ActionDescriptor());
    ...
    public async Task<string> RenderViewToStringAsync<TModel>(string viewName, TModel model)
    {
        ...
        var actionContext =
            new ActionContext(httpContext, new RouteData(), new ActionDescriptor()); //GetActionContext();
        var view = FindView(actionContext, viewName);

...
public class CarSeeder
{
    ...
    private Domain.CarRental GetCarRental()
    {
        return new Domain.CarRental
        {
            Name = "Wypożyczalnia u wuja",
            City = "Miasto Średniowiecza",
        ...
        var results = new Car()
        {
            ...
            CarBrand = new()
            {
                ...
                Images = new List<Image>()
                {
                    ...
                    {
                        Alt = "Volkswagen",
                        Src = "https://www.wyborkierowcow.pl/wp-content/uploads/2022/07/Volkswagen-logo.jpg"
                    }
                }
            },
